...
class categoryCtrl extends jControllerDaoCrud {

    protected $dao = 'bo~produits';

    protected $form = 'bo~produits';
...
/*
                ...
                'index'      =>array('jacl2.right'=>'bo.category.view'),
                'precreate'  =>array('jacl2.right'=>'bo.category.create'),
                'create'     =>array('jacl2.right'=>'bo.category.create'),
                'savecreate' =>array('jacl2.right'=>'bo.category.create'),
                'preupdate'  =>array('jacl2.right'=>'bo.category.update'),
                'editupdate' =>array('jacl2.right'=>'bo.category.update'),
                'saveupdate' =>array('jacl2.right'=>'bo.category.update'),
                'view'       =>array('jacl2.right'=>'bo.category.view'),
                'delete'     =>array('jacl2.right'=>'bo.category.delete')
*/
    );
